...
namespace Clubster\Bundle\AdBundle\Security\Voter;
...
{
    const
        CREATE = 'clubster.ad.create',
        EDIT = 'clubster.ad.update',
        DELETE = 'clubster.ad.delete',
        LIST = 'clubster.ad.index';
    ...
    protected function supports($attribute, $subject)
    {
        ...
        if (!empty($subject) && !$subject instanceof Ad) {
            return false;
        }
