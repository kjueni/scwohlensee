...
namespace Clubster\Bundle\PlayerBundle\Security\Voter;
...
{
    const
        CREATE = 'clubster.player.create',
        EDIT = 'clubster.player.update',
        DELETE = 'clubster.player.delete',
        LIST = 'clubster.player.index';
    ...
    protected function supports($attribute, $subject)
    {
        ...
        if (!empty($subject) && !$subject instanceof Player) {
            return false;
        }
